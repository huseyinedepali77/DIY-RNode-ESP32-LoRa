...
#include "Modem.h"
  ...
  #define BOARD_PROMICRO_DIY  0x52
  #define MODEL_52            0x52 // Micro-Mesh / Pro-Micro DIY nRF52840 with SX1262
  ...
  #define PIN_DISP_SLEEP -1
    ...
    #define PIN_GPS_RX 34
      ...
      // SX1262 pins for Micro-Mesh
      const int pin_reset = _PINNUM(0, 9);   // P0.09
      const int pin_cs    = _PINNUM(1, 13);  // P1.13
      const int pin_sclk  = _PINNUM(1, 11);  // P1.11
      const int pin_mosi  = _PINNUM(1, 15);  // P1.15
      const int pin_miso  = _PINNUM(0, 2);   // P0.02
      const int pin_busy  = _PINNUM(0, 29);  // P0.29
      const int pin_dio   = _PINNUM(0, 10);  // P0.10
      const int pin_rxen  = _PINNUM(0, 17);  // P0.17
      const int pin_txen  = -1;
      const int pin_led_rx = 33;             // Dummy pin 33
      const int pin_led_tx = 34;             // Dummy pin 34
      const int pin_tcxo_enable = -1;
