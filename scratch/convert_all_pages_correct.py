...
for fname, content in pages.items():
    ...
    for d in dirs:
        ...
        with open(filepath, "w", encoding="utf-8") as f:
            f.write(compiled)
    print(f"Successfully compiled {fname} using format_block!")
"""

    run_ssh("cat << 'EOF' > /root/convert_pages_correct.py\n" + converter_code + "\nEOF")
    out, err = run_ssh("python3 /root/convert_pages_correct.py")
