...
for fname, content in pages.items():
    ...
    for d in dirs:
        ...
        with open(filepath, "w", encoding="utf-8") as f:
            f.write(compiled)
    print(f"Successfully compiled relative link page {fname}!")
"""

    run_ssh("cat << 'EOF' > /root/convert_relative_pages.py\n" + converter_code + "\nEOF")
    out, err = run_ssh("python3 /root/convert_relative_pages.py")
