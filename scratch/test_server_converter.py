...
index_md = '''# Çınarcık Mesh Düğümü - Ana Sayfa
...
converter = MarkdownToMicron(index_md)
micron_output = str(converter)

with open('/root/.nomadnetwork/storage/pages/index.mu', 'w', encoding='utf-8') as f:
    f.write(micron_output)
with open('/root/.nomadnet/storage/pages/index.mu', 'w', encoding='utf-8') as f:
    f.write(micron_output)

print('Converted index.mu successfully!')
"
"""
